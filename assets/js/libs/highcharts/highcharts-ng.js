    ...
    return {
      ...
      link: function (scope, element, attrs) {
        ...
        scope.$watch("config.credits.enabled", function (enabled) {
          ...
          // TODO fix legend showing
        scope.$watch("config.legend.enabled", function (enabled) {
          if (enabled) {
            //chart.legend.show();
          } else if (chart.legend) {
            //chart.legend.hide();
          }
        });
		
        scope.$watch("config.tooltip.enabled", function (enabled) {
          if (enabled) {
            chart.tooltip.show();
        ...
        scope.$watch("config.exporting.enabled", function (enabled) {
          if (enabled) {
            chart.exporting.show();
          } else if (chart.exporting) {
            chart.exporting.hide();
          }
        });
